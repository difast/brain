...
`public/mevratek-platform.pdf` — буклет о платформе на одной странице A4, тот
же файл, который раздаётся на отраслевых мероприятиях. Один лист намеренно:
его печатают на чём угодно без настроек, и он читается целиком за минуту. Он опубликован на странице
