...
export const metadata: Metadata = {
  ...
  description:
    "Mevratek — российская облачная платформа управления промышленными роботами и автономными устройствами. Подключите устройство через единый SDK и получайте команды от AI-движка.",
          ...
          <div className="grid items-center gap-12 lg:grid-cols-[1.05fr_0.95fr]">
            <div>
              <div className="mb-5 inline-flex items-center gap-2 rounded-full border border-line bg-surface px-3 py-1 text-xs font-medium text-muted">
                ...
                Российская платформа · AI Decision Engine
              </div>
              <h1 className="text-4xl font-semibold leading-[1.05] sm:text-5xl lg:text-[3.4rem]">
                Облачный мозг для любого автономного устройства
              </h1>
              <p className="mt-5 max-w-xl text-lg leading-relaxed text-muted">
                ...
                получайте структурированные команды от AI-движка на базе
                российских языковых моделей.
              </p>
      ...
      <Section className="bg-surface">
        <Container>
          <SectionHeading
            ...
            intro="Mevratek — облачная платформа, которая позволяет подключить любое автономное устройство через единый SDK и API, передавать телеметрию в реальном времени и получать структурированные команды от AI-движка на базе российских языковых моделей. Платформа не привязана к производителю железа: один и тот же протокол работает с промышленным роботом, складской тележкой и симулятором."
          />
          <div className="mt-10">
            <FlowDiagram />
          </div>
