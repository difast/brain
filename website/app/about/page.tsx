...
const ROADMAP = [
  {
    year: "Сейчас",
    title: "Платформа и SDK",
    detail:
      "Движок решений, слой абстракции над железом, официальные SDK для пяти языков и локальное развёртывание. Работает, обкатывается на пилотах.",
  },
  {
    year: "2026",
    title: "Пилоты на реальном парке",
    detail:
  ...
  {
    year: "2026–2027",
    title: "Коробочная поставка Enterprise",
    detail:
